...
namespace CS1131_LibraryApi.Controllers
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        //Not using nullable types here would cause validation erroes when searching without filling all fields, as .NET 6 and higher considers non-nullable parameters as implicily required
        {
